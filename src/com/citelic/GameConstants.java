...
public final class GameConstants {
	...
	/* Server limits */
	public static final int RECEIVE_DATA_LIMIT = 10000; // bytes
	public static final int PACKET_SIZE_LIMIT = 10000; // bytes
	public static final long MAX_PACKETS_DECODER_PING_DELAY = 30000; // 30
	// seconds
	public static final int PLAYERS_LIMIT = 1000;
