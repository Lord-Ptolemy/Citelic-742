...
public class FriendsIgnores implements Serializable {
	...
	public void addFriend(String username) {
		...
		player.getPackets().sendFriend(
				Utilities.formatPlayerNameForDisplay(username), displayName, 1,
				online, online);
	...
	public void addIgnore(String username, boolean tillLogout) {
		...
		if (p2 == null)
			p2 = Engine.getLobbyPlayerByDisplayName(username);
		String formatedUsername = p2 != null ? p2.getUsername() : Utilities
				.formatPlayerNameForProtocol(username);
		...
		player.getPackets().sendIgnore(
				Utilities.formatPlayerNameForDisplay(p2 != null ? p2
						.getUsername() : username),
				p2 != null ? p2.getDisplayName() : Utilities
	...
	public void changeFriendStatus(Player p2, boolean online) {
		...
		player.getPackets().sendFriend(
				Utilities.formatPlayerNameForDisplay(p2.getUsername()),
	...
	public void sendFriendsMyStatus(boolean online) {
		...
		for (Player p2 : Engine.getLobbyPlayers()) {
