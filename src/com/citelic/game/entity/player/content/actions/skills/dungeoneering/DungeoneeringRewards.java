    ...
    public enum DungeonReward {
        ...
        static {
            for (DungeonReward monster : DungeonReward.values()) {
                DungeonReward.monsters.put(monster.slotId, monster);
            }
        }
        ...
        private DungeonReward(int id, int slotId, int req, int cost) {
            ...
            this.cost = cost;
            this.slotId = slotId;
            name = ItemDefinitions.getItemDefinitions(id).getName();
        }

        public static DungeonReward forId(int id) {
            return DungeonReward.monsters.get(id);
        }
