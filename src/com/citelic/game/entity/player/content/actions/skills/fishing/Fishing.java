...
public class Fishing extends Action {
	...
	private int getFishingDelay(Player player) {
		...
		int randomAmt = Utilities.random(4);
	...
	private int getRandomFish(Player player) {
		int random = Utilities.random(spot.getFish().length);
	...
	public enum FishingSpots {
		...
		NET3(323, 1, 303, -1, new Animation(621), Fish.SHRIMP, Fish.ANCHOVIES),
		...
		LURE4(315, 1, 309, 314, new Animation(622), Fish.TROUT, Fish.SALMON),

		BAIT(328, 2, 307, 313, new Animation(622), Fish.PIKE),

		BAIT2(329, 2, 307, 313, new Animation(622), Fish.PIKE, Fish.CAVE_FISH),

		BAIT3(323, 2, 307, 313, new Animation(622), Fish.PIKE),

		BAIT4(317, 2, 307, 313, new Animation(622), Fish.PIKE),

		BAIT5(315, 2, 307, 313, new Animation(622), Fish.PIKE),
		...
		HARPOON3(324, 2, 311, -1, new Animation(618), Fish.TUNA,
				Fish.SWORDFISH, Fish.SHARK),

		BIG_NET(313, 1, 305, -1, new Animation(620), Fish.MACKEREL, Fish.COD,
				Fish.BASS, Fish.SEAWEED, Fish.OYSTER),

		CRAYCAGE(14907, 1, 13431, -1, new Animation(619), Fish.CRAYFISH),

		CRAYCAGE2(14907, 1, 13431, -1, new Animation(619), Fish.CRAYFISH);
		static final Map<Integer, FishingSpots> spot = new HashMap<Integer, FishingSpots>();

		static {
			for (FishingSpots spots : FishingSpots.values()) {
				FishingSpots.spot.put(spots.id | spots.option << 24, spots);
			}
		}
		...
		public static FishingSpots forId(int id) {
			return FishingSpots.spot.get(id);
		}
