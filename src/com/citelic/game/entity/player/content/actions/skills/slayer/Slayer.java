package com.citelic.game.entity.player.content.actions.skills.slayer;
...
public class Slayer {
	...
	public static boolean canAttackNPC(int slayerLevel, String name) {
		return slayerLevel >= Slayer.getLevelRequirement(name);
	}
	...
	public static boolean hasEarmuffs(Entity target) {
		...
		return hat == 4166 || hat == 13277 || Slayer.hasSlayerHelmet(target);
	}
	...
	public static boolean hasFullSlayerHelmet(Entity target) {
		...
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == 15492 || hat == 15496 || hat == 15497 || hat >= 22528
				&& hat <= 22550;
	}
	...
	public static boolean hasNosepeg(Entity target) {
		...
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == 4168 || Slayer.hasSlayerHelmet(target);
	}
	...
	public static boolean hasSlayerHelmet(Entity target) {
		...
		return hat == 13263 || hat == 14636 || hat == 14637
				|| Slayer.hasFullSlayerHelmet(target);
	}
	...
	public static boolean hasSpinyHelmet(Entity target) {
		...
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == 4551 || Slayer.hasSlayerHelmet(target);
	}
	...
	public static boolean isUsingBell(final Player player) {
		...
		List<GameObject> objects = Engine.getRegion(player.getRegionId())
				.getObjects();
		if (objects == null)
			return false;
		for (final GameObject object : objects) {
			...
			EngineTaskManager.schedule(new EngineTask() {
				...
				@Override
				public void run() {
					NPC npc = Engine.spawnNPC(5751, player, -1, true);
					npc.getCombat().setTarget(player);
					GameObject o = new GameObject(object);
					o.setId(22544);
					Engine.spawnObjectTemporary(o, 30000);
				}
			}, 1);
			return true;
		}
	...
	public enum SlayerMaster implements Serializable {
		...
		SPRIA(8462, 85, 1, new int[] { 0, 0, 0 }, new int[] { 15, 50 },
				SlayerTask.BEAR, SlayerTask.COW, SlayerTask.BIRD,
				SlayerTask.CAVE_BUG, SlayerTask.CAVE_SLIME, SlayerTask.DWARF,
				SlayerTask.CRAWLING_HAND, SlayerTask.DWARF, SlayerTask.GOBLIN,
				SlayerTask.SPIDER, SlayerTask.ZOMBIE,
				SlayerTask.CHAOS_DWARF_HAND_CANNONEER),
		...
		MAZCHNA(8481, 20, 1, new int[] { 2, 5, 15 }, new int[] { 40, 85 },
				...
				SlayerTask.CRAWLING_HAND, SlayerTask.CYCLOPS, SlayerTask.DOG,
				SlayerTask.GHOUL, SlayerTask.HILL_GIANT, SlayerTask.HOBGOBLIN,
				SlayerTask.ICE_WARRIOR, SlayerTask.KALPHITE,
				SlayerTask.PYREFIEND, SlayerTask.ROCKSLUG, SlayerTask.VAMPYRE,
				SlayerTask.ZOMBIE),
		...
		VANNAKA(1597, 40, 1, new int[] { 4, 20, 60 }, new int[] { 60, 120 },
				SlayerTask.ABERRANT_SPECTRE, SlayerTask.BASILISK,
				SlayerTask.BLOODVELD, SlayerTask.COCKATRICE,
				SlayerTask.CYCLOPS, SlayerTask.DUST_DEVIL,
				SlayerTask.EARTH_WARRIOR, SlayerTask.GHOUL,
				SlayerTask.GREEN_DRAGON, SlayerTask.HILL_GIANT,
				SlayerTask.ICE_GIANT, SlayerTask.ICE_WARRIOR,
				SlayerTask.INFERNAL_MAGE, SlayerTask.JELLY,
				SlayerTask.LESSER_DEMON, SlayerTask.MOSS_GIANT,
				SlayerTask.OGRE, SlayerTask.PYREFIEND, SlayerTask.TUROTH,
		...
		CHAELDAR(1598, 70, 1, new int[] { 10, 50, 100 },
				...
				SlayerTask.BLUE_DRAGON, SlayerTask.BRONZE_DRAGON,
				SlayerTask.CAVE_CRAWLER, SlayerTask.CRAWLING_HAND,
				SlayerTask.DAGANNOTH, SlayerTask.DUST_DEVIL,
				SlayerTask.FIRE_GIANT, SlayerTask.FUNGAL_MAGE,
				SlayerTask.GARGOYLE, SlayerTask.JUNGLE_STRYKEWYRM,
				SlayerTask.INFERNAL_MAGE, SlayerTask.JELLY,
				SlayerTask.KALPHITE, SlayerTask.KALPHITE,
				SlayerTask.LESSER_DEMON, SlayerTask.TUROTH,
		...
		SUMONA(7780, 85, 35, new int[] { 12, 60, 180 }, new int[] { 120, 185 },
				...
				SlayerTask.AQUANITE, SlayerTask.BASILISK,
				SlayerTask.BLACK_DEMON, SlayerTask.BLOODVELD,
				SlayerTask.BLUE_DRAGON, SlayerTask.CAVE_CRAWLER,
				SlayerTask.DAGANNOTH, SlayerTask.DESERT_STRYKEWYRM,
				SlayerTask.DUST_DEVIL, SlayerTask.FUNGAL_MAGE,
				SlayerTask.GARGOYLE, SlayerTask.GREATER_DEMON,
				SlayerTask.HELLHOUND, SlayerTask.IRON_DRAGON,
				SlayerTask.JUNGLE_STRYKEWYRM, SlayerTask.KALPHITE,
				SlayerTask.JADINKO, SlayerTask.NECHRYAEL,
				SlayerTask.RED_DRAGON, SlayerTask.SPIRITUAL_MAGE,
				SlayerTask.SPIRITUAL_WARRIOR, SlayerTask.TUROTH),
		...
		DURADEL(8466, 100, 50, new int[] { 15, 75, 225 },
				...
				SlayerTask.FUNGAL_MAGE, SlayerTask.GARGOYLE, SlayerTask.GORAK,
				SlayerTask.GREATER_DEMON, SlayerTask.HELLHOUND,
		...
		KURADAL(9085, 110, 75, new int[] { 18, 90, 270 },
				...
				SlayerTask.DARK_BEAST, SlayerTask.DESERT_STRYKEWYRM,
				SlayerTask.DUST_DEVIL, SlayerTask.FIRE_GIANT,
				SlayerTask.GARGOYLE, SlayerTask.HELLHOUND,
				SlayerTask.IRON_DRAGON, SlayerTask.JUNGLE_STRYKEWYRM,
				SlayerTask.KALPHITE, SlayerTask.LIVING_ROCK,
				SlayerTask.MITHRIL_DRAGON, SlayerTask.JADINKO,
				SlayerTask.NECHRYAEL, SlayerTask.SKELETAL_WYVERN,
				SlayerTask.SPIRITUAL_MAGE, SlayerTask.STEEL_DRAGON,
				SlayerTask.TZHAAR, SlayerTask.TZHAAR,
				SlayerTask.WARPED_TORTOISE, SlayerTask.WATERFIEND);
	...
	public enum SlayerTask implements Serializable {// 79 matches out of 117
		...
		BIRD(
				1,
				new String[] {
						"Birds are a type of species found throughout Nevellion in different forms.",
		...
		// finished
		CHAOS_DWARF_HAND_CANNONEER(1, new String[] {});
		...
		public String getName() {
			return Utilities.formatPlayerNameForDisplay(toString());
		}
