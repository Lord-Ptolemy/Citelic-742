...
public class PyramidPlunder extends Controller {
	...
	public boolean login() {
		player.setNextTile(new Tile(3288, 2801, 0));
	...
	public void process() {
		if (snakeUrn == true && snakeUrn2 == true && snakeUrn3 == true
			...
			player.setNextTile(new Tile(3288, 2801, 0));
			player.getSkills().addXp(Skills.THIEVING, Utilities.random(1000));
			player.closeInterfaces();
			removeController();
		}
	}
	...
	public boolean processObjectClick1(GameObject object) {
		...
		if (object.getId() == 16531) {
			...
			if (Utilities.random(3) == 0) {
				...
				player.applyHit(new Hit(player, Utilities.random(150),
				...
				player.getPackets().sendConfigByFile(2359, 1);
				player.getInventory().addItem(995, Utilities.random(30000));
				snakeUrn = true;
			}
		}
	...
	public void start() {
		resetAllConfigs();
		player.setNextTile(new Tile(1974, 4424, 0));
