...
public enum WarriorsArmour {
	 ...
	 */
	BRONZE(new int[] { 1075, 1117, 1155 }, 4278, 10), IRON(new int[] { 1153,
			1115, 1067 }, 4279, 20), STEEL(new int[] { 1157, 1119, 1069 },
			4280, 30), BLACK(new int[] { 1165, 1125, 1077 }, 4281, 40), MITRHIL(
			new int[] { 1159, 1121, 1071 }, 4282, 50), ADAMANT(new int[] {
			1161, 1123, 1073 }, 4283, 60), RUNE(new int[] { 1127, 1079, 1163 },
			4284, 80), ;
