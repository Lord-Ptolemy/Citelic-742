...
public final class QueenBlackDragonController extends Controller {
	...
	public static final Tile OUTSIDE = GameConstants.RESPAWN_PLAYER_LOCATION;
	...
	public boolean processObjectClick1(GameObject object) {
			...
			FadingScreen.fade(player, new Runnable() {
				...
				public void run() {
					...
					player.getPackets().sendDestroyObject(
							new GameObject(70849, 10, 0, base.transform(24, 21,
									-1)));
					player.getPackets().sendDestroyObject(
							new GameObject(70837, 10, 0, base.transform(22, 24,
									-1)));
					player.getPackets().sendDestroyObject(
							new GameObject(70840, 10, 0, base.transform(34, 24,
									-1)));
					Engine.removeObject(
							new GameObject(70775, 10, 0, base.transform(31, 29,
									-1)), true);
					player.getPackets().sendDestroyObject(
							new GameObject(70822, 10, 0, base.transform(21, 35,
									-1)));
					player.getPackets().sendDestroyObject(
							new GameObject(70818, 10, 0, base.transform(39, 35,
									-1)));
					player.setNextTile(base.transform(31, 36, -1));
					boolean resizable = player.getInterfaceManager()
							.hasRezizableScreen();
					player.getPackets().closeInterface(resizable ? 746 : 548,
							resizable ? 1 : 0);
		...
		if (object.getId() == npc.getActiveArtifact().getId()) {
			...
			npc.setActiveArtifact(new GameObject(object.getId() + 1, 10, 0,
					object));
			npc.setHitpoints(npc.getMaxHitpoints());
			npc.setCantInteract(false);
			npc.setPhase(npc.getPhase() + 1);
			Engine.spawnObject(npc.getActiveArtifact(), false);
			switch (object.getId()) {
			case 70777:
				player.getPackets().sendGlobalConfig(1924, 2);
				player.getPackets()
						.sendSpawnedObject(
								new GameObject(70843, 10, 0, base.transform(24,
										21, -1)));
				break;
			case 70780:
				...
				player.getPackets()
						.sendSpawnedObject(
								new GameObject(70845, 10, 0, base.transform(24,
										21, -1)));
				break;
			case 70783:
				...
				player.getPackets()
						.sendSpawnedObject(
								new GameObject(70847, 10, 0, base.transform(24,
										21, -1)));
				break;
			case 70786:
				...
				player.getPackets()
						.sendSpawnedObject(
								new GameObject(70849, 10, 0, base.transform(24,
										21, -1)));
				break;
			}
			return false;
					...
					FadingScreen.unfade(player, time, new Runnable() {
						...
						public void run() {
							npc = new QueenBlackDragon(player, base.transform(
									31, 37, 0), base);
							player.setNextTile(base.transform(33, 28, 0));
