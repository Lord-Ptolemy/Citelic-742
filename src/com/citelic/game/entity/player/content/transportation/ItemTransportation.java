...
public class ItemTransportation {
    ...
    private static final Tile[][] COORDINATES = new Tile[][] {
	{ new Tile(3316, 3232, 0), new Tile(2443, 3089, 0), new Tile(2416, 2836, 0), new Tile(1701, 5600, 0) }
	, { new Tile(2880, 3559, 0), new Tile(2519, 3571, 0), new Tile(2970, 9679, 0), new Tile(2886, 4377, 0), }
	, { new Tile(3087, 3496, 0), new Tile(2918, 3176, 0), new Tile(3105, 3251, 0), new Tile(3293, 3163, 0) }
	, { new Tile(3087, 3496, 0), new Tile(2918, 3176, 0), new Tile(3105, 3251, 0), new Tile(3293, 3163, 0) }
	, { new Tile(2614, 3386, 0), new Tile(3032, 3337, 0), new Tile(2933, 3291, 0), new Tile(3143, 3442, 0) }
	, { new Tile(2878, 3542, 0), new Tile(3191, 3363, 0), new Tile(2606, 3220, 0), new Tile(2657, 3238, 0) }
	, { new Tile(3356, 3421, 0) }, { new Tile(3167, 3492, 0), new Tile(2527, 3860, 0) }, { new Tile(3353, 3006, 0), new Tile(3427, 3538, 0), new Tile(2787, 3616, 0), new Tile(3150, 4666, 0) }
	, { new Tile(4744, 5156, 0), new Tile(4599, 5062, 0), new Tile(4613, 5128, 0), new Tile(4744, 5170, 0) }
	, { new Tile(2339, 3171, 0) }, { new Tile(3305, 3489, 0) }, { new Tile(3423, 2914, 0) }, { new Tile(2796, 3082, 0) }
	, { new Tile(3170, 2982, 0) }, { new Tile(2294, 3626, 0) }, { new Tile(2519, 3860, 0) }, { new Tile(3054, 3295, 0) }
	, { new Tile(3565, 3312, 0), new Tile(3491, 3199, 0), new Tile(3626, 9618, 0), new Tile(3628, 3364, 0), new Tile(3633, 9696, 0) } };
	...
	if (!checkAll(player, item, index, 0, 1))
	    return false;
	player.getDialogueManager().startDialogue("ItemTransportationD", TELEPORT_NAMES[index], item.getId());
	return true;
    }
