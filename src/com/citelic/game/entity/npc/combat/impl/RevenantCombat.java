	...
	public int attack(final NPC npc, final Entity target) {
		...
		if (attackStyle == 2) { // checks if can melee
			...
			if ((distanceX > size || distanceX < -1 || distanceY > size || distanceY < -1))
				attackStyle = Utilities.random(2);
		}
		...
		case 0: // magic
			...
			Engine.sendProjectile(npc, target, 1276, 34, 16, 30, 35, 16, 0);
		...
		case 1: // range
			...
			Engine.sendProjectile(npc, target, 1278, 34, 16, 30, 35, 16, 0);
