...
public class KrilTsutsaroth extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		...
		int attackStyle = Utilities.getRandom(2);
		switch (attackStyle) {
		case 0:// magic flame attack
			...
			for (Entity t : npc.getPossibleTargets()) {
				...
				Engine.sendProjectile(npc, t, 1211, 41, 16, 41, 35, 16, 0);
				if (Utilities.getRandom(4) == 0)
		...
		case 2:// melee attack
			...
			for (Entity e : npc.getPossibleTargets()) {
				if (e instanceof Player
					...
					player.setPrayerDelay(Utilities.getRandom(5) + 5);
					player.getPackets()
							.sendGameMessage(
