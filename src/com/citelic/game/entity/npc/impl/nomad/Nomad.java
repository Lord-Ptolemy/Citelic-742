...
public class Nomad extends NPC {
	...
	public void createCopies(final Player target) {
		...
		final int thisIndex = Utilities.random(4);
	...
	public Tile getThroneTile() {
		 ...
		 */
		return throneTile == null ? new Tile((getRegionX() << 6) + 32,
				(getRegionY() << 6) + 32, getZ()) : throneTile;
	}
	...
	public void setNextMovePerform() {
		nextMovePerform = Utilities.currentTimeMillis()
				+ Utilities.random(20000, 30000);
	}
	...
	public boolean useSpecialSpecialMove() {
		return Utilities.currentTimeMillis() > nextMovePerform;
	}
