package com.citelic.cache.impl;
...
public class ObjectDefinitions {
    ...
    public static void clearObjectDefinitions() {
        ObjectDefinitions.objectDefinitions.clear();
    }

    public static int[] findDoorPairs(int openDoorId) {
        ObjectDefinitions open = ObjectDefinitions.getObjectDefinitions(openDoorId);
        ...
        main:
        for (int x = 0; x < Utilities.getObjectDefinitionsSize(); x++) {
            ObjectDefinitions other = ObjectDefinitions.getObjectDefinitions(x);
    ...
    public static ObjectDefinitions getObjectDefinitions(int id) {
        ...
        if (def == null) {
            ...
            def.id = id;
            byte[] data = Cache.STORE.getIndexes()[16].getFile(ObjectDefinitions.getArchiveId(id), id & 0xff);
            if (data == null) {
            ...
            ObjectDefinitions.objectDefinitions.put(id, def);
        }
        return def;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        ObjectDefinitions defs = ObjectDefinitions.getObjectDefinitions(75089);
