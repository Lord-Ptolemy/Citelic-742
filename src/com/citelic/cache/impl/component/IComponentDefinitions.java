package com.citelic.cache.impl.component;
...
public class IComponentDefinitions {
	...
	private static IComponentDefinitions[][] icomponentsdefs = new IComponentDefinitions[Utilities
	...
	public static IComponentDefinitions[] getInterface(int id) {
		...
		if (icomponentsdefs[id] == null) {
			icomponentsdefs[id] = new IComponentDefinitions[Utilities
