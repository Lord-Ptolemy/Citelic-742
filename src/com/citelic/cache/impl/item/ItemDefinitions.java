package com.citelic.cache.impl.item;
...
public final class ItemDefinitions {
	...
	static { // that's why this is here
		itemsDefinitions = new ItemDefinitions[Utilities
	...
	public String getDestroyMessage() {
		switch (this.getId()) {
		case 12629:
			return "You can get this back in the Stronghold of Security.";
		default:
			return "You can get it back where you found it.";
		}
	}
}